      ...
      <div className="sm:h-[65vh] md:h-[65vh] lg:h-[80vh] h-[40vh] w-full flex items-center justify-center text-center">
        <main className="px-4 sm:px-6 lg:px-8 z-10 lg:pb-8">
          <div className="text-center2">
            <h2 className="text:sm sm:text-lg md:text-2xl lg:text-3xl xl:text-[2.50rem] -tracking-tight md:leading-10 lg:leading-[3.5rem] font-semibold  text-white   font-lato lg:px-10">
              {props.title}
            </h2>
          </div>
        </main>
