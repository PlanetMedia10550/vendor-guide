...
const Graph = (props) => {
  return (
    <div className="col-span-3  md:col-span-3 lg:col-span-2 order-1 md:order-2 sm:mb-0 mb-5">
      <div className="border-solid border-[1px] border-[#171717] bg-white lg:mt-12">
        <div className="grid grid-cols-12 sm:gap-8">
          <div className="col-span-12 lg:col-span-7 md:col-span-7 order-2 sm:order-1">
            <div className="card lg:pl-4">
          ...
          <div className="col-span-12 lg:col-span-5 md:col-span-5  order-2 sm:order-1">
            <div className="grid grid-cols-12 pt-6 px-3 lg:px-0">
              <div className="col-span-12  md:col-span-6  order-2 sm:order-1 ">
                <p className="font-semibold text-lg">
                  {" "}
                  Sort{" "}
                  <span>
                    <FontAwesomeIcon icon={faSort} className="w-[0.6rem]" />
                  </span>
                </p>
            ...
            <div className="py-10 lg:pt-16 px-5 lg:px-0">
              <ul className="text-gray-700 pl-3">
                <li className="font-semibold text-xs">
                  <span className="pr-3">
                    <FontAwesomeIcon
                      icon={faWindowMinimize}
                      className="text-blue-600 w-[1.2rem]"
                    />
                  </span>
                  Bids Created
                </li>
                <li className="font-semibold text-xs flex items-baseline">
                  <span className="pr-3">
                    <FontAwesomeIcon
                      icon={faWindowMinimize}
                      className="text-emerald-500 w-[1.2rem]"
                    />
                  </span>
                  Issued Bids
                </li>
                <li className="font-semibold text-xs flex items-baseline">
                  <span className="pr-3">
                    <FontAwesomeIcon
                      icon={faWindowMinimize}
                      className="text-red-600 w-[1.2rem]"
                    />
                  </span>
                  Closed Bids
                </li>
                <li className="font-semibold text-xs">
                  <span className="pr-3">
                    <FontAwesomeIcon
                      icon={faWindowMinimize}
                      className="text-orange-400 w-[1.2rem]"
                    />
                  </span>
                  Awarded Bids
                </li>
                <li className="font-semibold text-xs flex items-baseline">
                  <span className="pr-3">
                    <FontAwesomeIcon
                      icon={faWindowMinimize}
                      className="text-lime-400 w-[1.2rem]"
                    />
                  </span>
                  Cancelled Bids
                </li>
