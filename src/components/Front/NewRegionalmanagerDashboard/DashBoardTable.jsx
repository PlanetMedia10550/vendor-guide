    ...
    return (
        <tr key={i} className="odd font-semibold">
                    
                {
                    row.map((r1,i) => {
                        return (
                        <td key={i} className="p-4 pr-8  border-b-[1px] border-black sorting_1 whitespace-nowrap text-sm justify-around">  <Link  href="" className="border-b-2 border-transparent hover:border-red-700 hover:text-red-700">{r1}</Link></td>
