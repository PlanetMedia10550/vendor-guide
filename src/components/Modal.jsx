        ...
        <div className="relative w-full max-w-4xl max-h-full mx-auto" >
           <div className="relative bg-white rounded-md shadow-lg " >
              <div className="py-10 px-16">
                 <button type="button" className="bg-gray-800 text-white hover:bg-gray-900 hover:text-gray-900 rounded-full text-sm w-9 h-9 ml-auto inline-flex justify-center items-center dark:hover:bg-gray-900 dark:hover:text-white  float-right " data-modal-hide="static-modal" fdprocessedid="inegfv" onClick={onClose}>
