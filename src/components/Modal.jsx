const Modal = ({ isOpen, onClose, children }) => {
    return isOpen ? (
        ...
        <div data-modal-backdrop="static" data-modal-placement="top-center" tabIndex="-1" aria-hidden="true" id="request_qoute" className="fixed  left-0 right-0 z-50  w-full p-6 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-0rem)] max-h-full bg-gray-500 bg-opacity-50 transition-opacity z-50">
        <div className="relative  top-[16rem] sm:top-3rem left-0 right-0  w-full max-w-4xl max-h-full mx-auto" >
