...
export default function Page({params}) {
    ...
    useEffect(() => {
      const getProducts = () => {
        ...
        axios.get(`${process.env.BASE_API_URL+'blog'}/${params.slug}`).then(function(response) {
      ...
      <section id="featurs_section" className="py-9 md:py-5">
        <div className="container mx-auto overflow-hidden pb-5 pt-5 md:pt-12 px-5 md:px-8 xl:px-24">
          <div className="mx-auto max-w-7xl">
            <div className="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-3 lg:grid-cols-3 xl:gap-x-5">
              {blog &&
                  (
                    <>
